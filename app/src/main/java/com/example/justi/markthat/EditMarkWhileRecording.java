...
public class EditMarkWhileRecording extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_mark_while_recording);
        //toolbar
...
//        Stetho.initializeWithDefaults(this);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db.updateMark(fileName, position, s1, s2, position);
